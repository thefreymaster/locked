  ...
  return (
    <>
      ...
      <Box
        ...
        alignItems="center"
      >
        <RackRecommendation recommended={props.lock.recommended} />
        <RackSize size={props.lock.size} />
        <RackTraffic traffic={props.lock.traffic} />
        <ToolTip label="Overall Rating">
          <Badge>
            ...
            >
              ...
              <Box marginRight="1px" />
              <Font fontSize="12px" fontWeight={900}>
